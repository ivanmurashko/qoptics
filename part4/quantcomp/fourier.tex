...
From \eqref{eqPart4QuantCompShorQuantFourierSeries} and
...
From the formula \eqref{eqAddFourierDiscretFourierFFT} one can
...
Applying the Fourier transform only to the higher bits $\hat{F}^{\frac{M}{2}}$,
