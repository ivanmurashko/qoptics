...
As an example, consider the thermal excitation of photons in a single
mode:
\begin{equation}
\hat{\rho} = \sum_{(n)}
P_n\ket{n}\bra{n},
...
The equalities \eqref{eqCh1_teplovvozb}, \eqref{eqCh1_plank} can be written in
...
\label{eqCh1_plank2}
\end{equation}
At the same time, the density matrix \rindex{Density matrix}
takes the form:
\[
