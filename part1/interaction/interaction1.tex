%% -*- coding:utf-8 -*- 
\section{Interaction of an atom with the mode of the electromagnetic field}
...
corresponding to one photon in the mode. \rindex{photon} For large $n$, these two
...
\rindex{Variable Stark Effect}
\begin{remark}[Variable Stark Effect]
